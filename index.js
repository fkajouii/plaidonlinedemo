...
const APP_PORT = 8000;
// const PLAID_CLIENT_ID = "***__PLAID_CLIENT_ID___***";
// const PLAID_SECRET = "***__PLAID_SECRET___***";
const PLAID_PUBLIC_KEY = "15abab06bf66667ae837e55a07e700";
const PLAID_ENV = "sandbox";

// PLAID_PRODUCTS is a comma-separated list of products to use when initializing
// Link. Note that this list must contain 'assets' in order for the app to be
// able to create and retrieve asset reports.
var PLAID_PRODUCTS = envvar.string(
  "PLAID_PRODUCTS",
  "auth,identity,income"
  // "transactions,auth,identity,income,assets"
);
...
app.get("/income", function(request, response, next) {
  // Pull the Item - this includes information about available products,
  // billed products, webhook information, and more.
  client.getIncome(ACCESS_TOKEN, function(error, itemResponse) {
    if (error != null) {
      prettyPrintResponse(error);
      return response.json({
        error: error
